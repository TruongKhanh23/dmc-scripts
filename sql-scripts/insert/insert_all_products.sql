...
UNION ALL
SELECT substr(md5(random()::text), 1, 24), 'admin', 'admin', NOW(), NOW(), FALSE, (SELECT id FROM public.products WHERE name = 'Cà phê muối chai'), (SELECT id FROM public.product_volumes WHERE name = '500'), 'Cà phê muối chai 500ml'
WHERE NOT EXISTS (SELECT 1 FROM variant_cte WHERE name = 'Cà phê muối chai 500ml')
UNION ALL
...
UNION ALL
SELECT substr(md5(random()::text), 1, 24), 'admin', 'admin', NOW(), NOW(), FALSE,
  (SELECT id FROM public.product_variants WHERE name = 'Cà phê muối chai 500ml' AND product_id = (SELECT id FROM public.products WHERE name = 'Cà phê muối chai')),
  (SELECT id FROM public.branches WHERE name = ''),
  (SELECT id FROM public.sales_channels WHERE name = 'Tại quán'),
  60000
WHERE NOT EXISTS (
  SELECT 1 FROM price_cte WHERE
    variant_id = (SELECT id FROM public.product_variants WHERE name = 'Cà phê muối chai 500ml' AND product_id = (SELECT id FROM public.products WHERE name = 'Cà phê muối chai'))
    AND branch_id = (SELECT id FROM public.branches WHERE name = '')
    AND sales_channel_id = (SELECT id FROM public.sales_channels WHERE name = 'Tại quán')
)
UNION ALL
