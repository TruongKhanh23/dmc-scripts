const branches = [
  { name: '', address: '13C đại lộ Đồng Khởi, khu phố 6, phường Phú Khương, TP. Bến Tre' },
  ...
  { name: '', address: '71 Đ. Hậu Giang, Phường 5, Quận 6, Thành phố Hồ Chí Minh' },
  { name: '', address: '3/26 Quang Trung, Thị trấn Hóc Môn, Hóc Môn, Thành phố Hồ Chí Minh' },
  ...
  { name: '', address: '194 Đường Cách Mạng Tháng 8, phường 10, Quận 3, Thành phố Hồ Chí Minh' },
  ...
  { name: '', address: 'Số 7 Bình Long, phường Bình Hưng Hòa A, quận Bình Tân' },
  { name: '', address: '244 Thích Quảng Đức, Phú Cường, Thủ Dầu Một, Bình Dương' },
  { name: '', address: '17A Ngô Tất Tố, P.21, Q. Bình Thạnh' },
  { name: '', address: '308 Lê Văn Việt, Tăng Nhơn Phú, Thủ Đức (Quận 9 cũ)' },
  { name: '', address: '101 Thích Quảng Đức, Phú Cường, thành phố Thủ Dầu Một, Bình Dương' },
  { name: '', address: '6B Công Trường Quốc Tế (hồ con rùa), P.6, Q.3' },
  { name: '', address: '204 Hà Huy Giáp, phường Quyết Thắng, thành phố Biên Hoà, tỉnh Đồng Nai' },
  ...
  { name: '', address: '102 Hoàng Hoa Thám, phường Thắng Tam, Thành phố Vũng Tàu, tỉnh Bà Rịa - Vũng Tàu' },
  { name: '', address: '108 Trần Hưng Đạo, phường An Nghiệp, quận Ninh Kiều, Thành phố Cần Thơ' },
  { name: '', address: '615 Cách Mạng Tháng 8, Khu phố 2, phường Long Toàn, Thành phố Bà Rịa' },
  { name: '', address: '884 Phú Riềng Đỏ, phường Tân Xuân, Thành phố Đồng Xoài, tình Bình Phước' },
  { name: '', address: '601 Cách Mạng Tháng 8, P.3, TP Tây Ninh' },
  { name: '', address: 'Số 25 Trưng Nữ Vương, Phường 1, TP Vĩnh Long, Tỉnh Vĩnh Long' },
  { name: '', address: '404 Lê Văn Lương, Phường Tân Hưng, Quận 7, TPHCM' },
  { name: '', address: 'Số 88 quốc lộ 62 , Phường 2 , Thành phố Tân An , Long An' },
  { name: '', address: 'Số 32 đường Trần Hưng Đạo, Thành phố Phan Thiết, Bình Thuận' },
  { name: '', address: 'Cà Phê Muối Chú Long - Trạm Dừng Chân Trảng Bom' },
  { name: '', address: '77/7A Khu Văn Hải, Long Thành, Đồng Nai ( Đối diện bưu điện Long Thành)' },
  ...
  { name: '', address: '143 Liêu Bình Hương, Ấp Tân Lập, Xã Tân Thông Hội, Huyện Củ Chi' },
